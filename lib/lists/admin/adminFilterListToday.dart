...
class AdminFilterToday extends StatefulWidget {
  final String? data;
  AdminFilterToday({super.key, this.data});

  @override
  State<AdminFilterToday> createState() => _AdminFilterTodayState();
}

class _AdminFilterTodayState extends State<AdminFilterToday> {
          ...
          child: isRefreshed
              ...
              : (widget.data == "")
                  ...
                  : ListView.builder(
                      ...
                      itemCount: appAdminToday.isEmpty
                          ? 0
                          : appAdminToday[currentIndex].length,
                      itemBuilder: (BuildContext context, int index) {
                        // Display each item in the sublist as a ListTile
                        final item = appAdminToday[currentIndex][index];
            ...
            ? Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      //  - ${subLists.length}
                      '${currentIndex + 1} - ${appAdminToday.length}',
                    ...
                    IconButton(
                      ...
                      onPressed: currentIndex < appAdminToday.length - 1
                          ? () {
                              setState(() {
                                isRefreshed = true;
                              });
