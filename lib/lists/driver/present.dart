...
class _PresentListState extends State<PresentList> {
  ...
  Future<List<Map<String, dynamic>>> tripListPresent() async {
    ...
    if (response.statusCode == 200) {
      ...
      for (var courses in apiData['courses']) {
        ...
        print('For course ID: $id, Status1: $status1, Status2: $status2');
        ...
        tripPresentAPI.add({
          ...
          "imgType": imgType,
          "chauffeur": chauffeur,
          "latitudeDepart": Latitude1,
          "longitudeDepart": longitude1,
          // "latitudeArrrive": Latitude2,
          // "LongitudeArrive": longitude2
        });
      }
  ...
  int calculateItemCount() {
    ...
    print('Item Count: $itemCount');
    print('PresentList length: ${tripsPresent.length}');

    // // itemCount += isAtEndOfList ? 0 : 0;

    print('Item Count: $itemCount');
    if (itemCount > tripsPresent.length) {
      // Adjust itemCount without using setState
      print('PresentList length: ${tripsPresent.length}');
      itemCount = tripsPresent.length;
  ...
  Future<Map<String, double>> addressToCoordinates1(String address) async {
    ...
    try {
      ...
      if (locations.isNotEmpty) {
        ...
        print('in the list function : $Latitude1');
        print('in the list function: $longitude1');
...
// Inside the onPressed callback of the forward arrow IconButton
  ...
  Coords currentLocation = Coords(0.00, 0.00);
