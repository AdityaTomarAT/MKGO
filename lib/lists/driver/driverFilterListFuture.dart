...
class DriverFilterFuture extends StatefulWidget {
  final String? data;
  final String screen;
  DriverFilterFuture({super.key, required this.screen, this.data});

  @override
  State<DriverFilterFuture> createState() => _DriverFilterListFutureState();
}

class _DriverFilterListFutureState extends State<DriverFilterFuture> {
  @override
  void initState() {
    super.initState();
  ...
  int calculateItemCount() {
    ...
    print('Item Count: $itemCount');
    print('DriverFilterFuture length: ${DriverListFilter.length}');
            ...
            child: isRefreshed
                ...
                : (widget.data == "")
                    ...
                    : ListView.builder(
                        ...
                        itemCount: appDriverAvenir.isEmpty
                            ? 0
                            : appDriverAvenir[currentIndex].length,
                        itemBuilder: (BuildContext context, int index) {
                          // Display each item in the sublist as a ListTile
                          final item = appDriverAvenir[currentIndex][index];
                                  ...
                                  children: [
                                    ListTile(
                                      ...
                                      trailing: GestureDetector(
                                          onTap: () {
                                            Get.to(
                                              () => TripDetails(Screen: "futureFilter",
                                                id: item['id'].toString(),
                                              ),
                                            );
                                          },
            ...
            ? Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      //  - ${subLists.length}
                      '${currentIndex + 1} - ${appDriverAvenir.length}',
                    ...
                    IconButton(
                      ...
                      onPressed: currentIndex < appDriverAvenir.length - 1
                          ? () {
                              setState(() {
                                isRefreshed = true;
                              });
