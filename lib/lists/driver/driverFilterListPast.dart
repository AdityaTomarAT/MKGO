...
class DriverFilterPast extends StatefulWidget {
  final String? data;
  final String screen;
  DriverFilterPast({super.key, required this.screen, this.data});

  @override
  State<DriverFilterPast> createState() => _DriverFilterListPastState();
}

class _DriverFilterListPastState extends State<DriverFilterPast> {
  @override
  void initState() {
    super.initState();
  ...
  int calculateItemCount() {
    ...
    print('Item Count: $itemCount');
    print('DriverFilterPast length: ${DriverListFilter.length}');
            ...
            child: isRefreshed
                ...
                : (widget.data == "")
                    ...
                    : ListView.builder(
                        ...
                        itemCount: appDriverPast.isEmpty
                            ? 0
                            : appDriverPast[currentIndex].length,
                        itemBuilder: (BuildContext context, int index) {
                          // Display each item in the sublist as a ListTile
                          final item = appDriverPast[currentIndex][index];
            ...
            ? Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      //  - ${subLists.length}
                      '${currentIndex + 1} - ${appDriverPast.length}',
                    ...
                    IconButton(
                      ...
                      onPressed: currentIndex < appDriverPast.length - 1
                          ? () {
                              setState(() {
                                isRefreshed = true;
                              });
