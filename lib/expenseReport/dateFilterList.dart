...
class DateFilter extends StatefulWidget {
  ...
  const DateFilter({super.key, required this.list});
  ...
  Future<void> _fetchAdminData() async {
    ...
    try {
      ...
      for (int i = 0; i < expenseList.length; i += 10) {
        ...
        subListsDateFilter.add(expenseList.sublist(i, endIndex));
      }
              ...
              Expanded(
                child: LiquidPullToRefresh(
                  ...
                  child: ListView.builder(
                    shrinkWrap: true,
                    itemCount: subListsDateFilter.isEmpty
                        ? 0
                        : subListsDateFilter[currentIndex].length,
                    itemBuilder: (BuildContext context, int index) {
                      // Display each item in the sublist as a ListTile
                      final item = subListsDateFilter[currentIndex][index];
                      ...
                      if (subListsDateFilter.length == 0) {
                        Center(
                          child:
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      //  - ${subLists.length}
                      '${currentIndex + 1} - ${subListsDateFilter.length}',
                    ...
                    IconButton(
                      ...
                      onPressed: currentIndex < subListsDateFilter.length - 1
                          ? () {
                              setState(() {
                                isRefreshed = true;
                              });
