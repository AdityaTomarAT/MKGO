...
class SuccessPassworsdScreen extends StatefulWidget {
  final String notes;

  SuccessPassworsdScreen({Key? key, required this.notes}) : super(key: key);

  @override
  State<SuccessPassworsdScreen> createState() => _SuccessSState();
}

class _SuccessSState extends State<SuccessPassworsdScreen> {
  @override
