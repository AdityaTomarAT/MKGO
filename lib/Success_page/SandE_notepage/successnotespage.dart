...
class SuccessNotesScreen extends StatefulWidget {
  final String notes;

  SuccessNotesScreen({Key? key, required this.notes}) : super(key: key);

  @override
  State<SuccessNotesScreen> createState() => _SuccessSState();
}

class _SuccessSState extends State<SuccessNotesScreen> {
  @override
