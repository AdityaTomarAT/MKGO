...
class FailednotesScreen extends StatefulWidget {
  
  const FailednotesScreen({super.key});

  @override
  State<FailednotesScreen> createState() => _ErroRState();
}

class _ErroRState extends State<FailednotesScreen> {
  @override
